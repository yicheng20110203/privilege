  ...
  <div class="dashboard-container">
    <el-scrollbar>
      <el-form ref="dataForm" :model="dataForm" label-width="auto" size="medium" label-suffix=":">
        ...
        <el-form-item label="图片介绍" prop="detail">
          <el-col :span="16">
            <div class="edit_container">
              <!-- <editor ref="Editor" v-model="dataForm.detail" :content="dataForm.detail" /> -->
        ...
        <el-form-item label="选择文章">
          <el-button type="primary" @click="selectVideoHandle">+选择文章</el-button>
    ...
    >
      ...
      >
        ...
        <el-table-column prop="entity_id" label="文章" header-align="center" align="center" />
        <el-table-column prop="size_desc" label="文章大小" header-align="center" align="center" />
...
import { ISDELETE, TYPE_ARTICLE, SECTION_ARTICLE, MATERIAL_ARTICLE, DATETIME } from '@/utils/global-element'
  ...
  methods: {
    ...
    getmaterialArticleDataList(type = {}) {
      getMaterialList(this.$service.adornData({
        ...
        if (res && res.code === 0) {
          this.materialArticleDataList = res.data.list
        } else {
          this.materialArticleDataList = []
        }
      })
    },
    // 素材-文章-查询
    selectMaterialVideoHandle() {
      this.getmaterialArticleDataList({ 'type': TYPE_ARTICLE, 'category_key': this.selectDataForm.materialclass[0] })
    },
    // 每页数
